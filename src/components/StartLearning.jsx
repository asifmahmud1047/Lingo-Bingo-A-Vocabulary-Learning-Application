...
const StartLearning = () => {
  ...
  return (
    <div className="p-6 max-w-7xl mx-auto">
      <h1 className="text-3xl font-bold mb-6 text-center">Let&apos;s Learn Japanese</h1>
      
      {!user ? (
        <div className="bg-yellow-100 p-4 rounded-lg mb-6 text-center">
          <p className="mb-2">You need to be logged in to access the lessons and track your progress.</p>
        ...
        <p className="mb-6 text-center">Welcome back, {user.displayName || "Learner"}! Ready to continue your Japanese language journey?</p>
      )}
      ...
      <div className="mb-12">
        ...
        <div className="aspect-w-16 aspect-h-9">
          <iframe 
            ...
            src="https://www.youtube.com/embed/2gWq0eSuH5Y" 
            title="Japanese Hiragana & Katakana Tutorial"
            frameBorder="0" 
